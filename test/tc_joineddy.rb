...
class TestJoinEddies < Test::Unit::TestCase
  ...
  def test_binary_join
   ...
   def test_self_join
     ...
     e = Crocus::PushJoinEddy.new('e1', 4, [r1,r2], [[[r1, [0]], [r2, [0]]]]) do |i|
       outs << i
     end
     r.wire_to(r1)
     r.wire_to(r2)
   ...
   def test_cross_product
     ...
     r = Crocus::PushElement.new('r', 2)
     s = Crocus::PushElement.new('s', 2)
     e = Crocus::PushJoinEddy.new('e1', 4, [r,s], []) do |i|
       outs << i
     end
     r.wire_to(e)
     s.wire_to(e)
  ...
  def test_cyclic_query
    ...
    s = Crocus::PushElement.new('s', 2)
    t = Crocus::PushElement.new('t', 2)
    e = Crocus::PushJoinEddy.new('e', 6, [r,s,t], [[[r, [0]], [s, [0]]], [[s, [0]], [t, [0]]], [[t,[0]], [r, [0]]]]) do |i|
      outs << i
    end
    r.wire_to(e)
    s.wire_to(e)
  ...
  def test_eddy_recursion
    ...
    j = Crocus::PushJoinEddy.new('e', 2, [link,path], [[[link,[1]],[path,[0]]]]) do |i|
      tup = [i[0], i[3]]
